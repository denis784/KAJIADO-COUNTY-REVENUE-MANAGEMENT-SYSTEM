        ...
        <div class="card-body" id="print_div">
            <div class="row">
                ...
                <div class="receipt-main col-xs-12 col-sm-12 col-md-12 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
                    <h3>
                        <center>KAJIADO COUNTY REVENUE COLLECTION MANAGEMENT SYSTEM</center>
                    </h3>
                    <div class="row">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:right; padding-right:20px;">
                                        <strong><i class="fa fa-inr"></i>Ksh
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:right; padding-right:20px;">
                                        <strong><i class="fa fa-inr"></i>Ksh <?php echo $rs['Balance'];?></strong>
                                    </td>
                                </tr>
                                <tr>
