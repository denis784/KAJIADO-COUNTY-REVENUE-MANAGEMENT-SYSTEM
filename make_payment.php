...
if($_POST['cardNum']==NULL){
	...
	$Message->originator = '+254779909982';
	$Message->recipients = array(+254779909982);
    ...
    $MessageBird->messages->create($Message);
		  ...
		  AMOUNT PAID.: Ksh '.$AmountPaid.'<br/>
		  BALANCE DUE.: Ksh '.$Balance.'<br/>
		  <br/>
		  <hr style="border-style:dotted; border-color: black;" />
			  <center>&copy;2022, KAJIADO COUNTY REVENUE COLLECTION MANAGEMENT SYSTEM</center>
		  <br/>
		  <i>
                ...
                if(ISSET($_POST['step2'])){
				  ...
				  <div class="container-fluid">
					<form action="" id="make_payment" method="POST">
					  ...
					  <div class="form-group">
						<label for="Balance" class="control-label">Outstanding Balance(KSh)</label>
						<input type="number" class="form-control form-control-sm" name="Balance" id="Balance" value="'.$rs['CurrentBalance'].'" readonly>
					  </div>
					  <div class="form-group">
						<label for="amountToPay" class="control-label">Amout to pay(Ksh)</label>
					  ...
					  <div class="form-group">
						<label for="CurrentBalance" class="control-label">Current Balance(Ksh)</label>
