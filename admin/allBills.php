...
$content .= '
		<tr><td>'.$row['PropertyId'].'</td><td>'.$row['Property'].'</td><td>ZMK '.$row['ChargeableFee'].'</td><td>ZMK '.$row['BalanceBF'].'</td><td>ZMK '.$row['AmountPayable'].'</td><td>ZMK '.$row['AmountPaid'].'</td><td>ZMK '.$row['CurrentBalance'].'</td></tr>
		';
	}
}else{
$content .= '
