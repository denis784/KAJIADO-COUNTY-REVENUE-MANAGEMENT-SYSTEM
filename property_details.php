...
<tr><th>PROPERTY VALUE</th><td>Ksh <?php echo $row['ChargeableFee'];?></td></tr>
<tr><th>BALANCE BF</th><td>Ksh <?php echo $row['BalanceBF'];?></td></tr>
<tr><th>AMOUNT DUE</th><td>Ksh <?php echo $row['AmountPayable'];?></td></tr>
<tr><th>AMOUNT CLEARED</th><td>Ksh <?php echo $row['AmountPaid'];?></td></tr>
<tr><th>CURRENT BALANCE DUE</th><td>Ksh <?php echo $row['CurrentBalance'];?></td></tr>
