...
<div class="row">
    ...
    <div class="col-12 col-sm-6 col-md-4">
        <div class="info-box">
            ...
            <div class="info-box-content">
                <span class="info-box-text">Kajiado Total Revenue Collection</span>
                <span class="info-box-number">
                    <?php 
        ...
        <div class="card card-shadow border-0 mb-4">
            <div class="card-body d-flex">
                <div class="">
                    ...
                    <p class="mt-3">You can now pay for your revenue online.</p>
                </div>
            </div>
        </div>
    </div>
